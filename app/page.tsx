  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="mb-10">
        ...
        <p className="text-muted-foreground text-lg mb-6">Una colección de mis trabajos de diseño y desarrollo web</p>
      ...
      <section>
        ...
        {projects.length === 0 ? (
          <div className="text-center py-10 border rounded-lg bg-muted/20">
            <p className="text-muted-foreground">No hay proyectos todavía. ¡Agrega tu primer proyecto!</p>
