...
export default function AgregarProyecto() {
	...
	const handleAddTechnology = () => {
		if (
			technology.trim() !== "" &&
			!technologies.includes(technology.trim())
		) {
		...
		<div className="container mx-auto px-4 py-8">
			...
			{bucketStatus.checking ? (
				...
				<Alert variant="destructive" className="mb-6">
					...
					<AlertDescription>
						<p className="mb-2">
							Es necesario crear el bucket "project-images" en Supabase
							Storage antes de poder subir imágenes.
						</p>
							...
							{bucketStatus.exists ? (
								...
								<div className="border border-dashed rounded-lg p-6 text-center bg-muted/20">
									<p className="text-muted-foreground">
										Configura el almacenamiento primero para poder
										subir imágenes
									</p>
								</div>
							)}
							...
							<div className="flex flex-wrap gap-2 mt-3">
								...
								{technologies.length === 0 && (
									<p className="text-sm text-muted-foreground">
										Agrega las tecnologías que utilizaste en este
										proyecto
									</p>
								)}
							</div>
